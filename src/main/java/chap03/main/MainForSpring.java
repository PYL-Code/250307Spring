...
public class MainForSpring {
	...
	private static ApplicationContext ctx = null; //필드. 싱글턴 느낌
	//static 없으면 MainForSpring 객체생성을 해야 쓸 수 있음 = main은 실행돼도 이 필드는 없음
	...
	private static void processNewCommand(String[] arg) {
		...
		MemberRegisterService regSvc =
				...
				//ctx.getBean(MemberRegisterService.class);  //이름 호출하지 않아도 작동함.
